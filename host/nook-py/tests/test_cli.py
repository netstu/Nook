...
from nook.cli import _build_parser, _format_repl_prompt, _parse_repl_command, main  # noqa: E402
...
class CliTests(unittest.TestCase):
    ...
    def test_top_level_help_mentions_frida_style_invocations(self) -> None:
        ...
        self.assertIn("{apps,ps,spawn,attach,call,detach,resume,post,unload,repl}", help_text)
